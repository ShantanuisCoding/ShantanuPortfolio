...
//             {/* Arrows ko image ke bahar shift kiya */}
//             <button
//               className="absolute left-0 top-1/2 -translate-y-1/2 z-50 bg-black hover:bg-accent text-white p-3 rounded-full border border-white"
...
//             <button
//               className="absolute right-0 top-1/2 -translate-y-1/2 z-50 bg-black hover:bg-accent text-white p-3 rounded-full border border-white"
...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <button
        className="fixed left-5 top-1/2 -translate-y-1/2 z-50 bg-transparent text-white p-4 rounded-full hover:scale-150"
      ...
      <button
        className="fixed right-5 top-1/2 -translate-y-1/2 z-50 bg-transparent text-white p-4 rounded-full hover:scale-150"
